...
{
    struct data_node *c_head, *ptr_1, *ptr_2, *c_ptr_1, *c_ptr_2;
    ...
    ptr_1 -> data = (a_head -> next -> data) + (b_head -> next -> data) - 1;
    ptr_1 -> next = NULL;
    ptr_1 -> prior = c_head;  
    c_head -> next = ptr_1;
    ptr_2 = ptr_1;
    ...
    for (int i = 0; i < overall_length(a_head) - a_head -> next -> data + overall_length(b_head) - b_head -> next -> data; i++)
    {
        ptr_1 = (struct data_node *)malloc(sizeof(struct data_node));
        ptr_1 -> data = 0;
        ptr_1 -> next = NULL;
    ...
    c_ptr_1 = c_head -> next -> next;
    ptr_1 = a_head -> next -> next;
    ptr_2 = b_head -> next -> next;
    while (ptr_1 != NULL)
    {
        c_ptr_2 = c_ptr_1;
        ptr_2 = b_head -> next -> next;
        ...
        while (ptr_2 != NULL)
        {
            c_ptr_2 -> data += (ptr_1 -> data) * (ptr_2 -> data);
            c_ptr_2 = c_ptr_2 -> next;
            ptr_2 = ptr_2 -> next;
        }

        c_ptr_1 = c_ptr_1 -> next;
        ptr_1 = ptr_1 -> next;
    }
